...
# Variables
GAMEDIR="/$directory/windows/shelter2"
SPLASH="/$directory/windows/.proton/tools/splash"
EXEC="$GAMEDIR/data/Shelter2.exe"
BASE=$(basename "$EXEC")
...
# This game saves in the Windows Registry of all places - HKEY_CURRENT_USER\Software\Might and Delight\Shelter 2\

#mkdir -p $GAMEDIR/config
#bind_directories "$WINEPREFIX/drive_c/users/steamuser/Documents/My Games/Soma" "$GAMEDIR/config"

# Run the game

$GPTOKEYB "$BASE" -c "$GAMEDIR/shelter2.gptk" &
