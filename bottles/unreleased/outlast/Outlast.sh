...
# Variables
GAMEDIR="/$directory/windows/outlast"
SPLASH="/$directory/windows/.proton/tools/splash"
EXEC="$GAMEDIR/data/Binaries/Win32/OLGame.exe"
BASE=$(basename "$EXEC")
...
bind_directories "$WINEPREFIX/drive_c/users/steamuser/Documents/My Games/Outlast" "$GAMEDIR/config"

# Run the game

$GPTOKEYB "$BASE" -xbox360 -c "$GAMEDIR/outlast.gptk" &
