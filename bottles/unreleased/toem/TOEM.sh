...
# Variables
GAMEDIR="/$directory/windows/toem"
SPLASH="/$directory/windows/.proton/tools/splash"
EXEC="$GAMEDIR/data/TOEM.exe"
BASE=$(basename "$EXEC")
...
bind_directories "$WINEPREFIX/drive_c/users/steamuser/AppData/LocalLow/Something We Made/TOEM" "$GAMEDIR/config"

# Run the game
$GPTOKEYB "$BASE" -c "$GAMEDIR/toem.gptk" &
