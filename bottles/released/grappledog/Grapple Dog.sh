...
# Variables
GAMEDIR="/$directory/windows/grappledog"
SPLASH="/$directory/windows/.wine/tools/splash"
EXEC="$GAMEDIR/data/Grapple Dog.exe"
BASE=$(basename "$EXEC")
...
# Source winesetup
source "/$directory/windows/.wine/winesetup"
...
bind_directories "$WINEPREFIX/drive_c/users/root/AppData/Local/Grapple_Dog" "$GAMEDIR/config"
...
# Run the game
$GPTOKEYB "$BASE" -c "$GAMEDIR/grappledog.gptk" &
